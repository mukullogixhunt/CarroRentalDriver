...
public class NotificationModel {
    ...
    @SerializedName("m_notif_booking")
    @Expose
    private String mNotifBooking;
    ...
    @SerializedName("m_notif_vendor")
    @Expose
    private String mNotifVendor;
    ...
    public String getmNotifBooking() {
        return mNotifBooking;
    }

    public void setmNotifBooking(String mNotifBooking) {
        this.mNotifBooking = mNotifBooking;
    }
    ...
    public String getmNotifVendor() {
        return mNotifVendor;
    }

    public void setmNotifVendor(String mNotifVendor) {
        this.mNotifVendor = mNotifVendor;
    }
